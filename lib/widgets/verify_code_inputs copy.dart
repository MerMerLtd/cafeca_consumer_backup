...
/*
  keyup -> checkFocus
  checkfocus -> if current column is filled -> next column
*/
  void _changeFocus(int index, TextEditingController tc) {
    ...
    print('${tc.text.isEmpty} + $index');
    // if (tc.text.isEmpty && index > 0 && _fn[index].hasFocus) {
    //   FocusScope.of(context).requestFocus(_fn[index - 1]);
    // }
  }
  ...
  void _saveForm() {
    ...
    verifyCode = verifyCodeArray.reduce((i, j) => i + j);
          ...
          Container(
            ...
            child: RaisedButton(
              ...
              onPressed: !_isCompleted
                  ...
                  : () {
                      _saveForm();
                      print(authState.getPhoneNo);
                      print(verifyCode);
                      // PageTransition(
                      //   type: PageTransitionType.upToDown,
                      //   child: CardsOverviewScreen(),
                      // );
                      Navigator.of(context)
                          .pushNamed(CardsOverviewScreen.routeName);
                    },
            ),
          ),
        ],
